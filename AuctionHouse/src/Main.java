public class Main{
    ...
    public static void main(String[] args) {
        ...
        collectibleList.populate("AuctionHouse/datasets/collectible_items.csv");
        // populate with missing fields data
        //collectibleList.populate("AuctionHouse/datasets/collectible_items_missing_fields.csv");
        // populate with wrongly typed data
        //collectibleList.populate("AuctionHouse/datasets/collectible_items_wrong_types.csv");
